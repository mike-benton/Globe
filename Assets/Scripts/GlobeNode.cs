...
{
    public bool hasTessellated;
    public string preConcatInfo;
    public Globe globe;
    ...
    {
        gameObject.GetComponentInChildren<TextMesh>().text = "Node " + listIndex + preConcatInfo;
    ...
    void OrganizeNeighbors()
    {
        ...
        {
            //preConcatInfo = "(" + newNeighbors.Count + ", " + newNeighbors2.Count + ")";
        ...
        else
        {
            ...
            if (newNeighbors.Count == 4)
            {
                newNeighbors.Add(newNeighbors2[1]);
                newNeighbors.Add(newNeighbors2[0]);
            }
            else if (newNeighbors.Count == 3)
            {
                newNeighbors.Add(newNeighbors2[2]);
                newNeighbors.Add(newNeighbors2[0]);
                newNeighbors.Add(newNeighbors2[1]);
            ...
            {
                newNeighbors.Add(newNeighbors2[4]);
                newNeighbors.Add(newNeighbors2[0]);
                newNeighbors.Add(newNeighbors2[1]);
                newNeighbors.Add(newNeighbors2[2]);
                newNeighbors.Add(newNeighbors2[3]);
